...
import { dealoftheday } from "../../constant/constant";
      ...
      <div className="relative">
        <Swiper
          ...
          navigation={
            isDesktop && showArrows
              ? { prevEl: ".deal-prev", nextEl: ".deal-next" }
              : false
          }
          spaceBetween={16}
          breakpoints={{
        ...
        >
          ...
          {isDesktop && showArrows && canSlidePrev && (
            <div className="deal-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 cursor-pointer">
              <Leftarrow />
            </div>
          )}
          {isDesktop && showArrows && canSlideNext && (
            <div className="deal-next absolute right-0 top-1/2 -translate-y-1/2 z-10 cursor-pointer">
              <Rightarrow />
            </div>
          )}
        </Swiper>
