  ...
  return (
    <div className="w-[87%] mx-auto py-10">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="relative flex items-center gap-2 text-[#b87a2c] font-medium text-sm cursor-pointer" onClick={() => navigate("/category/mens-bracelet")}>
      ...
      <div className="relative">
        ...
        >
          {menbraceletData.map((product, index) => (
