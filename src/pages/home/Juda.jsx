      ...
      <div className="relative">
        <Swiper
          ...
          navigation={
            isDesktop && showArrows
              ? { prevEl: ".juda-prev", nextEl: ".juda-next" }
              : false
          }
          spaceBetween={16}
          breakpoints={{
        ...
        >
          ...
          {isDesktop && showArrows && canSlidePrev && (
            <div className="juda-prev absolute left-0 top-1/2 -translate-y-1/2 z-10 cursor-pointer">
              <Leftarrow />
            </div>
          )}
          {isDesktop && showArrows && canSlideNext && (
            <div className="juda-next absolute right-0 top-1/2 -translate-y-1/2 z-10 cursor-pointer">
              <Rightarrow />
            </div>
          )}
        </Swiper>
